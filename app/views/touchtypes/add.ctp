...
<?php echo $this->element('nicedit-editor'); ?>

<div id="Page">

	<div id="Top"><h1>Add touch</h1></div>
	...
	<div id="Main">
		...
		<div id="Editor"><?php echo $form->input('lettercontent',array('label'=>false,'cols'=>80,'rows'=>30,'before'=>'<p class="subnote">You can use ' .$html->link('merge fields','/help#mergefields',array('target'=>'_blank')). ' to customize letters.</p>')); ?></div>		
